...
DATA_PATH = os.path.join(BASE_DIR, 'data', 'processed', 'nifty_merged_preprocessed.csv')
...
if __name__ == '__main__':
    ...
    forecast_path = os.path.join(MODELS_DIR, 'nifty_prophet_forecast.csv')
    forecast_out.to_csv(forecast_path, index=False)

    # --- STEP 7: Save model ---
    model_path = os.path.join(MODELS_DIR, 'nifty_prophet.pkl')
    ...
    print(f"\n{'=' * 60}")
    print("NIFTY PROPHET — FINAL SUMMARY")
    print(f"{'=' * 60}")
